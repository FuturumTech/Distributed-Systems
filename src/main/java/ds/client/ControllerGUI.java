...
public class ControllerGUI implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (label.equals("Invoke Service 1")) {
			...
			/*
			 * Build a channel to connect to the server, using localhost as IP and predefined port
			 */
			...
			ds.service1.DesiredRoomConditions request = ds.service1.DesiredRoomConditions.newBuilder().setRoomName(entry1.getText()).build();

			//retreving reply from service
			ds.service1.Confirmation response = blockingStub.desiredSettingHVAC(request);

			reply1.setText( String.valueOf( response.getConfirmation()) );
