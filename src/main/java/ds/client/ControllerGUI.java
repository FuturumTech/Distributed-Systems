...
//			ds.service1.RequestLength request = ds.service1.RequestLength.newBuilder().setText(entry1.getText()).build();
//
//			//retreving reply from service
//			ds.service1.ResponseLength response = blockingStub.getLength(request);
//
...
//
//			//preparing message to send
//			ds.service2.RequestLengthMessage request = ds.service2.RequestLengthMessage.newBuilder().setText(entry2.getText()).build();
//
//			//retreving reply from service
//			ds.service2.ResponseLengthMessage response = blockingStub.service2Length(request);
//
