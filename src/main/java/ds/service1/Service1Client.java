...
public class Service1Client {
	...
	public static void squared() {
		...
		System.out.println("squared() has been called:");
		...
		NumberResponse response = blockingStub.squared(request);

		// Display the result
		System.out.println(randomNumber + " squared is: " + response.getNumber() + "\n\n");
		System.out.println("sum() unary call has finished");
